...
namespace WebAppToys.Pages.Users
{
    public class UpdateModel : PageModel
    {
        ...
        {
            var newRoles = Request.Form["roles"]; //"roles" is referencing the name in the input from the html
            ...
            foreach (var r in OldRoles)//remove role
            {
            ...
            return RedirectToPage("./Index", new { success = true, message = "Update Sucessful"});
        }
    }
}
